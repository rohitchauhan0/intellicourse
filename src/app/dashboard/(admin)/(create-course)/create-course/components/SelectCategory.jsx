    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-8 prata-regular">
        {CategoryList.map((item, index) => (
          <div
            className={`flex flex-col gap-y-2 p-5 border border-emerald-500 hover:bg-emerald-500 hover:cursor-pointer rounded-xl justify-center items-center ${
              userCourseInput.category === item.name && "bg-emerald-500"
            }`}
