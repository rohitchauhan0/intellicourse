...
const ChapterList = ({ course, refreshData, edit = true }) => {
  ...
  return (
    <div className="my-5 border rounded-xl p-5">
      <h2 className="text-xl sm:text-2xl text-center text-steelblue">
        Chapters
      </h2>
      ...
      <div className="my-2">
        {loading
          ...
          : course?.courseOutput?.chapters.map((chapter, index) => (
              ...
              >
                <div className="flex gap-8 items-center">
                  <h2 className="h-10 w-10 bg-steelblue rounded-full text-center p-2 flex-none">
                    {index + 1}
                  </h2>
                  <div>
                    ...
                    <p className="flex items-center gap-2">
                      <ClockIcon className="w-5 h-5 text-steelblue" />
                      {chapter?.duration}
                    </p>
                  </div>
                </div>
