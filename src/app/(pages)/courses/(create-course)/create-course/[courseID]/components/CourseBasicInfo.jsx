...
import { storage } from "@/config/FirebseConfig";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          {loading ? (
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-emerald-500 flex items-center gap-2 justify-between">
          ...
          {loading ? (
            ...
            <h2 className="font-bold text-sm sm:text-base text-yellow-500 flex items-center gap-2">
          ...
          {!edit && (
            <Link href={`/courses/view/${course?.courseId}/start`}>
              <Button className="w-full my-5 bg-gradient-to-r from-emerald-400 to-yellow-500">Start</Button>{" "}
            </Link>
          )}
        </div>
